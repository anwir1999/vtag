...
RTC_DATA_ATTR char Location_Backup_Array[BU_Arr_Max_Num][550];
...
RTC_DATA_ATTR CFG VTAG_Configure = {.Period = 5, .Mode = 1, .Network = 2, .CC = 1, ._SS = 1, .WM = 1};
...
bool flag_check_wifi_motion = false;
...
void BackUp_UnsentMessage(VTAG_MessageType Mess_Type)
{
	...
	else
	{
		...
		else if(Mess_Type == STARTUP)
		{
			...
			if(Network_Type == GSM)
			{
				MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DON", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
			}
			else
			{
				MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, VTAG_NetworkSignal.RSRP, VTAG_Configure.CC, "DON", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
			}
		}
		else if(Mess_Type == LOWBATTERY)
		{
			...
			if(Network_Type == GSM)
			{
				MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DBL", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
			}
			else
			{
		...
		else if(Mess_Type == FULLBATTERY)
		{
			...
			if(Network_Type == GSM)
			{
				MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DBF", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, 0, VTAG_Vesion, 100, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
			}
			else
			{
				MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, VTAG_NetworkSignal.RSRP, VTAG_Configure.CC, "DBF", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, 0, VTAG_Vesion,100, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
			}
		}
		...
		if(Flag_DBL_Task == true)
		{
			if(VTAG_DeviceParameter.Bat_Level <= 15)
			{
				...
				if(Network_Type == GSM)
				{
					MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DBL", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Device_shutdown_ts, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
				}
				else
				{
					MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, VTAG_NetworkSignal.RSRP, VTAG_Configure.CC, "DBL", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Device_shutdown_ts, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
				}
				if(Backup_Array_Counter >= BU_Arr_Max_Num)
				{
					Backup_Array_Counter = BU_Arr_Max_Num - 1;
		...
		if(Flag_FullBattery == true)
		{
			...
			if(Network_Type == GSM)
			{
				MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DBF", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, 100, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
			}
			else
			{
				MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, VTAG_NetworkSignal.RSRP, VTAG_Configure.CC, "DBF", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, 100, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
			}
			if(Backup_Array_Counter >= BU_Arr_Max_Num)
			{
				Backup_Array_Counter = BU_Arr_Max_Num - 1;
		...
		if(strstr(VTAG_Configure.Type, "O"))
		{
			...
			if(Network_Type == GSM)
			{
				MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DOF", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
			}
			else
			{
...
void MQTT_SendMessage_Thread(VTAG_MessageType Mess_Type)
{
	...
	if(Mess_Type == FOTA_SUCCESS)
	{
		...
		if(Network_Type == GSM)
		{
			MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DOSS", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
		}
		else
		{
	...
	else if(Mess_Type == FOTA_FAIL)
	{
		...
		if(Network_Type == GSM)
		{
			MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DOFA", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
		}
		else
		{
	...
	else if(Mess_Type == STARTUP)
	{
		...
		if(Network_Type == GSM)
		{
			MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DON", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Device_shutdown_ts, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
		}
		else
		{
			MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, VTAG_NetworkSignal.RSRP, VTAG_Configure.CC, "DON", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode,  VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Device_shutdown_ts, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
	...
	else if(Mess_Type == PAIR)
	{
		...
		if(Network_Type == GSM)
		{
			MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DAD", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
		}
		else
		{
	...
	else if(Mess_Type == UNPAIR)
	{
		...
		if(Network_Type == GSM)
		{
			MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DUP", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
		}
		else
		{
	...
	else if(Mess_Type == UNPAIR_GET)
	{
		...
		if(Network_Type == GSM)
		{
			MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "GET", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
		}
		else
		{
	...
	else if(Mess_Type == DCF_ACK)
	{
		...
		if(Network_Type == GSM)
		{
			MQTT_DevConf_Payload_Convert(Mqtt_TX_Str, RSSI, VTAG_Configure.CC, "DCF", VTAG_NetworkSignal.RSRQ, VTAG_Configure.Period, VTAG_Configure.Mode, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, VTAG_DeviceParameter.Bat_Level, Network_Type_Str, VTAG_Configure.Network, VTAG_Configure._SS, VTAG_Configure.WM);
		}
		else
		{
	...
	if((VTAG_Configure_temp.Period != VTAG_Configure.Period || VTAG_Configure_temp.CC != VTAG_Configure.CC || \
			...
			VTAG_Configure_temp._SS != VTAG_Configure._SS || VTAG_Configure_temp.WM != VTAG_Configure.WM) \
			...
			VTAG_Configure_temp.Period != 0 && VTAG_Configure_temp.CC != 0)
	{
		...
		char str[100];
		sprintf(str, "{\"M\":%d,\"P\":%d,\"Type\":\"%s\",\"CC\":%d,\"N\":%d,\"a\":%d,\"T\":\"%s\",\"_ss\":%d,\"WM\":%d}",\
	...
	if(strstr(Device_PairStatus, VTAG_Configure.Type) == NULL) // if there is a change in pair/unpair status
	{
		if(strstr(VTAG_Configure.Type, "P") || strstr(VTAG_Configure.Type, "U") || strstr(VTAG_Configure.Type, "O") || strstr(VTAG_Configure.Type, "C"))
		{
			if(ACK_Succeed[WAIT_ACK] ==  MESS_UNPAIR && ACK_Succeed[ACK_DONE] == 1) // if DUP is succeed
			{
				...
				char str[100];
				sprintf(str, "{\"M\":%d,\"P\":%d,\"Type\":\"%s\",\"CC\":%d,\"N\":%d,\"a\":%d,\"T\":\"%s\",\"_ss\":%d,\"WM\":%d}", 1, 5,VTAG_Configure.Type, 1, VTAG_Configure.Network ,VTAG_Configure.Accuracy, "0", VTAG_Configure._SS, VTAG_Configure.WM);
				writetofile(base_path, "test.txt", str);
				// Shutdown device
				ESP_LOGI(TAG, "Shut down V-TAG\r\n");
...
void Bat_Wifi_Cell_Convert(char* str, char* wifi, uint8_t level, int MCC,int16_t RSRP, int16_t RSRQ, int RSSI,int cellID,int LAC,int MNC)
{
	if(Flag_LBS_need)
	{
		if(Network_Type == GSM)
		{
			sprintf(str,"{\"ss\":%d,\"Type\":\"DLBS\",\"_Type\":\"LBS\",\"B\":%d,\"r\":%d,\"C\":%s,\"T\":%lld,\"V\":\"%s\",\"RR\":%d%d,\"WDR\":\"%d%d\",", RSSI, level, RSRQ, cell_buffer, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, Reboot_reason, Backup_reason, wifi_detect_int, wd_reason);
			printf("cell_buffer: %s\r\n", str);
		}
		else
		{
			sprintf(str,"{\"ss\":%d,\"Type\":\"DLBS\",\"_Type\":\"LBS\",\"B\":%d,\"r\":%d,\"C\":%s,\"T\":%lld,\"V\":\"%s\",\"RR\":%d%d,\"WDR\":\"%d%d\",", RSRP, level, RSRQ, cell_buffer, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, Reboot_reason, Backup_reason, wifi_detect_int, wd_reason);
		}
		if (Network_Type == GSM)
		{
	...
	else
	{
		if(Network_Type == GSM)
		{
			sprintf(str,"{\"ss\":%d,\"Type\":\"DWFC\",\"_Type\":\"WIFI\",\"B\":%d,\"r\":%d,\"C\":[{\"C\":%d,\"S\":%d,\"ID\":%d,\"L\":%d,\"N\":%d}],\"T\":%lld,\"V\":\"%s\",\"RR\":%d%d,\"WDR\":\"%d%d\",", RSSI, level, RSRQ, MCC, RSSI, cellID, LAC, MNC, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, Reboot_reason, Backup_reason, wifi_detect_int, wd_reason);
		}
		else
		{
			sprintf(str,"{\"ss\":%d,\"Type\":\"DWFC\",\"_Type\":\"WIFI\",\"B\":%d,\"r\":%d,\"C\":[{\"C\":%d,\"S\":%d,\"ID\":%d,\"L\":%d,\"N\":%d}],\"T\":%lld,\"V\":\"%s\",\"RR\":%d%d,\"WDR\":\"%d%d\",", RSRP, level, RSRQ, MCC, RSSI, cellID, LAC, MNC, VTAG_DeviceParameter.Device_Timestamp, VTAG_Vesion, Reboot_reason, Backup_reason, wifi_detect_int, wd_reason);
		}
		if(strlen(wifi) > 0)
		{
...
#define SS_THR	65
	...
	char MAC_Weak_Serial_Pre[150] = {0};
	for (int i = 0; i < AP_count_pre; i++)
	{
...
void GPS_Position_Time_Str_Convert(char *str, uint8_t bat_lev, float accuracy, float lat, float lon, float alt, uint16_t year_t, uint8_t month_t, uint8_t date_t, uint8_t hour_t, uint8_t min_t, uint8_t sec_t)
{
	...
	if(Network_Type == GSM)
	{
		sprintf(str, "{\"Type\":\"DPOS\",\"_Type\":\"GPS\",\"V\":\"%s\",\"ss\":%d,\"r\":%d,\"B\":%d,\"Cn\":\"%s\",\"Acc\":%f,\"lat\":%d.%06d,\"lon\":%d.%06d,\"T\":%lld,\"RR\":%d%d,\"WDR\":\"%d%d\"}", VTAG_Vesion, RSSI, VTAG_NetworkSignal.RSRQ, bat_lev, Network_Type_Str, accuracy, interLat, fracLat, interLon, fracLon, VTAG_DeviceParameter.Device_Timestamp, Reboot_reason, Backup_reason, wifi_detect_int, wd_reason);
	}
	else
	{
		sprintf(str, "{\"Type\":\"DPOS\",\"_Type\":\"GPS\",\"V\":\"%s\",\"ss\":%d,\"r\":%d,\"B\":%d,\"Cn\":\"%s\",\"Acc\":%f,\"lat\":%d.%06d,\"lon\":%d.%06d,\"T\":%lld,\"RR\":%d%d,\"WDR\":\"%d%d\"}", VTAG_Vesion, VTAG_NetworkSignal.RSRP, VTAG_NetworkSignal.RSRQ, bat_lev, Network_Type_Str, accuracy, interLat, fracLat, interLon, fracLon, VTAG_DeviceParameter.Device_Timestamp, Reboot_reason, Backup_reason,wifi_detect_int, wd_reason);
	}
}
//------------------------------------------------------------------------------------------------------------------------// GPS decode
uint8_t GPS_Decode(char *buffer, float *lat, float *lon, float *speed_kph, float *heading, float *altitude,
...
void main_task(void *arg)
{
	...
	while (1)
	{
		...
		if(ProgramRun_Cause == ESP_SLEEP_WAKEUP_TIMER && Flag_motion_detected == false)
		{
		...
		if(Flag_Cycle_Completed == true && (ProgramRun_Cause == ESP_SLEEP_WAKEUP_UNDEFINED ||  Flag_FullBattery == true|| Flag_Fota == true || Flag_sos == true || Flag_motion_detected == true || acc_counter > 180 || Flag_period_wake == true || Flag_Unpair_Task == true) && Flag_button_do_nothing == false)
		{
			...
			{
				ESP_LOGE(TAG, "send mess when have motion detect\r\n");
			}
			else if(acc_counter > 180)
			{
				ESP_LOGE(TAG, "send mess when acc > 180\r\n");
			}
			else if(Flag_period_wake)
			{
				ESP_LOGE(TAG, "send mess when Flag_period_wake\r\n");
			}
			// check condition wifi detect motion
			if(((ProgramRun_Cause == ESP_SLEEP_WAKEUP_TIMER || ProgramRun_Cause == ESP_SLEEP_WAKEUP_EXT0) && VTAG_Configure.WM == 1) && 1)
			{
				if(Flag_wifi_init == false)
				{
					wifi_init();
				...
				if (ap_count > 4 && wifi_motion_detect == false && Flag_sos == false && Flag_Unpair_Task == false && Backup_Array_Counter == 0)
				{
					...
					acc_counter = (uint64_t)round(rtc_time_slowclk_to_us(rtc_time_get() - acc_capture, esp_clk_slowclk_cal_get())/1000000);
					ESP_LOGI(TAG, "acc_counter: %d s",(int)acc_counter);
					if(Flag_motion_detected == true && Flag_send_DAST == false && acc_counter > 180)
					{
						GetDeviceTimestamp();
...
//						flag_end_motion = true;
			...
			case  ESP_SLEEP_WAKEUP_EXT0:
			{
				if(Flag_Unpair_Task == true && Flag_motion_detected == false)
				{
					Flag_Unpair_Task = false;
					Flag_wifi_scan = true;
					ESP_LOGE(TAG, "send mess wwhen unpair");
					if(Flag_wifi_init == false)
					{
						wifi_init();
					}
			...
			case ESP_SLEEP_WAKEUP_TIMER:// Run main thread after getting timestamp
			{
				...
				// check condition wifi detect motion
//				if(((ProgramRun_Cause == ESP_SLEEP_WAKEUP_TIMER || ProgramRun_Cause == ESP_SLEEP_WAKEUP_EXT0) && VTAG_Configure.WM == 1) && 1)
				if(VTAG_Configure.WM == 1 && flag_check_wifi_motion == false)
				{
					if(Flag_wifi_init == false)
					{
						wifi_init();
	...
	//						flag_end_motion = true;
				...
				{
					ESP_LOGI(TAG, "cc = 2 and send mess");
				...
				{
					ESP_LOGI(TAG, "cc = 1 and send mess");
